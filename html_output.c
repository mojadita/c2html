/* $Id: html_output.c,v 1.1 1999/06/14 23:00:20 luis Exp $
...
FILE *html_create(char *name, char *title)
{
	...
	if (!f) {
		fprintf(stderr, PROGNAME": "__FILE__"(%d): %s: cannot create: %s\n",
			__LINE__, name, sys_errlist[errno]);
		exit(EXIT_FAILURE);
	}

	fprintf(f,"<!-- WARNING: This file was generated automatically with C2HTML, do not edit.\n");
	fprintf(f,"  -- "PROGNAME" "VERSION" -- A program to convert C source code into cross referenced HTML.\n");
	fprintf(f,"  -- Copyright (C) 1999 Luis Colorado <Luis.Colorado@SLUG.CTV.ES>\n");
	fprintf(f,"  --\n");
